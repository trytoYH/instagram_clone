...
SECRET_KEY = 'django-insecure-%3l)d4j-a*42e(d#p(!mhdbkn%*twr=qa0v+_8c-sla#=94lh4'
...
SETTINGS_PATH = os.path.normpath(os.path.dirname(__file__)) # for project template path
# insta_clone/templates
TEMPLATES = [
    {
